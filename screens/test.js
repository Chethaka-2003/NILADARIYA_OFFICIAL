...
export default function SignupScreen() {
    ...
    const handleSendVerification = () => {   // Verification Part
        if (!email) {
            Alert.alert('Error', 'Please enter your email to receive a verification code.');
            return;
        }
            ...
            <View style={styles.container}>
                ...
                <View style={styles.inputContainer}>
                   ...
                   <View style={styles.contBox}>
                    ...
                    <TouchableOpacity style={styles.button} onPress={handleRegister} disabled={!isCodeSent || isVerified}>
