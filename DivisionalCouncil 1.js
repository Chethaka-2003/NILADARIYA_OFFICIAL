...
const DivisionalCouncil = ({ route, navigation }) => {
    ...
    <SafeAreaView style={{ flex: 1 }}>
      ...
      <ScrollView contentContainerStyle={styles.scrollView}>
        ...
        <View style={styles.councilContainer}>
          ...
          <TouchableOpacity style={styles.serviceCard} onPress={() => navigation.navigate("OfficerSelecting")}>

            <View >
            <Icon name={"person-circle-outline"} size={30} color="#283747" alignSelf="center" />
              <Text style={styles.serviceCardTitle}>OFFICERS</Text>
            </View>
          </TouchableOpacity>
