...
export default function OfficerPage() {
  ...
  const API_BASE_URL = "https://niladariya-official-backend.onrender.com/auth";
  ...
  useEffect(() => {
    const fetchProfile = async () => {
      ...
      axios.get('https://niladariya-official-backend.onrender.com/auth/getprofile', {
        headers: {
  ...
  const removeImage = async () => {
    ...
    try {
      ...
      await axios.delete('https://niladariya-official-backend.onrender.com/auth/profilePicture');
        ...
        <View style={styles.profileDetails}>
          ...
          <View style={styles.iconContainer}>
            ...
            <View style={styles.iconCreate}>
              <TouchableOpacity style={styles.iconButton} onPress={() => navigation.navigate('SettingsPgOfficer')}>
